...
/* 
 * MASTER 
 * Created by Manuel Montenegro, February 26, 2017. 
 ...
 *   
 *  Compatible boards with this sketch: Arduino UNO, Arduino Leonardo & Arduino MEGA.
*/ 
/*********************************************************************************************/ 
...
void loop() { 
  ...
  if (userChoice == '1') { 
    ...
    PlayerCard card; 
    card.begin();                   
    card.format();                  // Formats a card
  } else if (userChoice == '4') { 
    PlayerCard card; 
    card.begin(); 
    card.readPunches();             // Reads and validates punches of a card
  } 
