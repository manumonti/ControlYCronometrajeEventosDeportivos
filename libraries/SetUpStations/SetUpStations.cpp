...
// Class constructor. If RTC battery doesn't work, This adjusts time to sketch compilated time
MasterSetUpStations::MasterSetUpStations () {
  ...
  p2p.SAMConfiguration();           // Configures the Secure Access Module of PN532 for P2P
